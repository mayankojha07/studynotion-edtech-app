    ...
    <>
      <div className="flex flex-col space-y-2">
        ...
        <div
          ...
          } flex min-h-64 cursor-pointer items-center justify-center rounded-md border-2 border-dotted border-richblack-500`}
        >
          {previewSource ? (
            ...
            >
              ...
              <p className="mt-2 max-w-[12.5rem] text-center text-sm text-richblack-200">
